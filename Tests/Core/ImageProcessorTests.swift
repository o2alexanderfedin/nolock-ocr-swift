...
final class ImageProcessorTests: XCTestCase {
    ...
    func testMissingResourceLoading() {
        ...
        XCTExpectFailure("This test should fail with a path in the error message")
        // Force the test to fail with shouldFail=true to see the error message
        _ = ImageProcessorTestHelper.loadResource(name: "deliberately-missing", extension: "HEIC", shouldFail: true)
    }
}